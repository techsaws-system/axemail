...
export const Template01HTML = (values: Template01HTMLValues) => {
  return `
    ...
    <p>Pursuant to <strong>15 U.S.C. Sections 1051-1052</strong> and in accordance with <strong>TMEP Sections 1401.02, 806.01, and 1202</strong>, your trademark application is currently undergoing initial examination at the <strong>United States Patent and Trademark Office (USPTO)</strong>.</p>
